...
<div class="question-item">2. 一間學校正在設計一個新的學生資料數據庫。下表是其中一個資料表「Student」的結構： <span class="points">(6 分)</span></div>
...
<div class="question-item">4. 小華正在製作一段關於校園生活的短片，並打算上傳至社交平台。他拍攝的影片屬性如下： <span class="points">(6 分)</span></div>
