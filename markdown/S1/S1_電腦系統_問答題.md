...
2.	什麼是TOPS（Tera operations per second）？
    A. 人工智能處理器效能的衡量標準
    B. 儲存容量的衡量標準
    C. 記憶體頻寬的衡量標準


3. 神經網絡處理器（NPU）的主要用途是什麼？
